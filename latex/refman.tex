...
\renewcommand{\familydefault}{\sfdefault}
  ...
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      unicode,%
      pdftitle={Mando},%
      pdfsubject={Proyecto Mando Inalámbrico}%
    }
...
\begin{document}
  ...
  [1ex]\large 1.\+0 \\
  \vspace*{1cm}
  {\large Generado por Doxygen 1.9.7}\\
  \end{center}
  \end{titlepage}
...
\input{structfsm__adc__t}
\input{structfsm__t}
\input{structfsm__trans__t}
\chapter{Documentación de archivos}
\input{fsm_8h}
\input{fsm_8h_source}
\input{fsm__adc_8h}
\input{fsm__adc_8h_source}
\input{main_8h}
\input{main_8h_source}
\input{fsm_8c}
\input{fsm__adc_8c}
\input{main_8c}
\input{_m_y___n_r_f24_8h_source}
\input{n_r_f24_l01_8h}
\input{n_r_f24_l01_8h_source}
